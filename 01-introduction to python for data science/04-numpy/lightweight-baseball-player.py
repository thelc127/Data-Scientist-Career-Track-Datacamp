...
# Print out the numpy array with the BMIs of all baseball players whose BMI is below 21. Use light
# inside square bracket to do a selection on the bmi array.
